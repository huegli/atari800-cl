...
## Stage 0 -- De-risk + unblock (~1/2 day) -- [x] COMPLETE (2026-06-08)
...
## Stage 1 -- Foundation: compat + input-state (~1 day) -- [x] COMPLETE (2026-06-08)
...
## Stage 2 -- Chip input delegation (~1/2 day, pure) -- [x] COMPLETE (2026-06-10)
...
## Stage 3 -- Machine concurrency core (~1-2 days, HIGH RISK, commit alone) -- [x] COMPLETE (2026-06-10)
...
## Stage 4 -- AESP / TCP track (~2-3 days, low portability risk) -- [x] COMPLETE (2026-06-10)
...
> runtimes** (was 1331; +28); LispWorks 3x clean.
...
## Stage 5 -- CLI / Unix-socket track (~2 days, gated on Spike A) -- [x] COMPLETE (2026-06-10)
...
> 5x clean. (Replaced a non-portable `#\Rs` literal with `(code-char #x1E)`.)
>
...
> summarizes the effort. **End-to-end facade smoke passes on both
...
1. **Abort granularity -> frame-granularity for MVP.** No `cpu-budget`
   ...
   pause/resume/reset. Scanline-granularity (~63 us) is a later refinement
   if needed.
