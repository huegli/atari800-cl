;;;; demos/edventure-demo-lispworks.lisp --- LispWorks driver for
;;;; demos/edventure-demo.lisp.
;;;;
;;;; Invoked by demos/edventure-demo.sh --impl lispworks via:
;;;;   lw-console -build demos/edventure-demo-lispworks.lisp
;;;;
...
;;;; demos/dos-boot-demo-lispworks.lisp uses; see its header for the
...
;;;; holds LispWorks's own arguments.  demos/edventure-demo.sh
...
;;;; branch's own comment in demos/edventure-demo.lisp for the one
...
(defun demo-pathname ()
  "Pathname of demos/edventure-demo.lisp, resolved next to this file."
